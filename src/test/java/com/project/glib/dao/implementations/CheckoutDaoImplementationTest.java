...
public class CheckoutDaoImplementationTest {
    ...
    public void alreadyHasThisCheckoutTrue() throws Exception {
        ...
        assertTrue(checkoutDao
                .alreadyHasThisCheckout(checkout1.getIdDoc(), checkout1.getDocType(), checkout1.getIdUser()));
        assertTrue(checkoutDao
                .alreadyHasThisCheckout(checkout2.getIdDoc(), checkout2.getDocType(), checkout2.getIdUser()));
        assertTrue(checkoutDao
                .alreadyHasThisCheckout(checkout3.getIdDoc(), checkout3.getDocType(), checkout3.getIdUser()));
