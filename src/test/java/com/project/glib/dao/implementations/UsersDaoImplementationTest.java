...
//        DocumentPhysical docPhys = docPhysDao.getById(docPhysDao.getValidPhysId(book.getId(), Document.BOOK));
...
//            usersDao.remove(user.getId());
//        } catch (Exception e) {
//            assertEquals(e.getMessage(), UsersDaoImplementation.REMOVE_USER_HAS_CHECKOUTS_EXCEPTION);
//        }
//
...
//        DocumentPhysical docPhys = docPhysDao.getById(docPhysDao.getValidPhysId(journal.getId(), Document.JOURNAL));
//        Checkout checkout = new Checkout(user.getId(), docPhys.getId(), docPhys.getDocType(),
//                System.nanoTime(), System.nanoTime() + CheckOutService.WEEK_IN_MILLISECONDS * 3,
//                false, docPhys.getShelf());
//        checkoutDao.add(checkout);
...
//        avDao.add(av, shelf);
//        DocumentPhysical docPhys = docPhysDao.getById(docPhysDao.getValidPhysId(av.getId(), Document.AV));
//        Checkout checkout = new Checkout(user.getId(), docPhys.getId(), docPhys.getDocType(),
//                System.nanoTime(), System.nanoTime() + CheckOutService.WEEK_IN_MILLISECONDS * 3,
//                false, docPhys.getShelf());
//        checkoutDao.add(checkout);
